...
import { getConsultas, createHistoria, deleteHistoria, getHistoriaId, updateHistoria, getConsultasCompletada, getConsultasPendiente,searchConsultations, getConsultasTotalCount, getConsultasCompletadasCount, getConsultasPendientesCount, getInsumosConsultorio, upload  } from "../controller/consultasController.js";
const router = Router();
...
router.get("/insumos-consultorio", getInsumosConsultorio);
